...
const baseStyle =
  "bg-transparent relative sm:bottom-[3vh] text-app_white rounded-lg px-3 sm:px-6 ml-1 sm:ml-4 py-3 font-semibold cursor-pointer text-[28px] leading-normal sm:text-[2vw]";
...
const Hero = () => {
  ...
  return (
    <div className='w-full'>
      <div
        id='Home'
        className='justify-center overflow-x-hidden w-full sm:justify-start py-[5vh] sm:py-0 flex mt-[8vh] sm:mt-[12vh] flex-col h-[78vh] sm:h-[76vh] items-center relative'
      >
        <AnimatePresence>
          {imageLoaded && (
            <motion.div
        ...
        {/* Background Images */}
        <img
          className='w-full h-[78vh] z-[2] -left-28 blur-[1px] sm:left-0 sm:h-[76vh] object-cover my-auto absolute'
          src='/images/fx2.jpg'
          onLoad={handleImageLoad}
        />
        <img
          className='w-full h-[78vh] opacity-100 blur-[1.5px] -right-[30vw] sm:hidden sm:h-[76vh] object-cover absolute'
          src='/images/fx2.jpg'
          onLoad={handleImageLoad}
        />
      </div>
      ...
      <Marquee>
        <h6 className='text-app_white font-medium flex items-center h-[8vh] sm:h-[12vh] capitalize text-[4vw] sm:text-[1.5vw]'>
          A creative and Innovative Studio
        </h6>
      </Marquee>
    </div>
  );
